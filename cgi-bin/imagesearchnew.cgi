...
echo "<form action=\"./imagesearchnew.cgi\" method=\"POST\"><input type=\"text\" name=\"SEARCH\" class=\"textbox green\"></td>"
...
then
	...
	do
		...
		then
			...
			echo "</form></td>"
			echo "<td><input type=\"button\" value=\"Info\" class=\"button black\" onclick=\"window.open('https://hub.docker.com/r/$SOURCE','_blank');\"></td></tr>"
			echo "<tr id=\"iframe-${COUNT}\"><tr>"
		fi	
