...
curl -s -H "Authorization: JWT ${TOKEN}" https://hub.docker.com/v2/repositories/j2systems/docker/tags/|jq -r '.results|.[]|"\(.name) \(.full_size) \(.last_updated)"'>/var/www/cgi-bin/tmp/dockerhub
